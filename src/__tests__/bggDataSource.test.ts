...
describe('BGGDataSource', () => {
  ...
  describe('normalizeLinks', () => {
    it('should normalize links with correct link types', async () => {
      const mockItem = {
        id: '13',
        type: 'boardgame',
        name: { type: 'primary', value: 'CATAN' },
        link: [
          { type: 'boardgamecategory', id: '1', value: 'Strategy' },
          { type: 'boardgamemechanic', id: '2', value: 'Trading' },
          { type: 'boardgameexpansion', id: '926', value: 'Cities & Knights' },
          { type: 'boardgamedesigner', id: '3', value: 'Klaus Teuber' },
          { type: 'boardgameartist', id: '4', value: 'Michael Menzel' },
          { type: 'boardgamepublisher', id: '5', value: 'Catan Studio' },
          { type: 'boardgamefamily', id: '6', value: 'Catan Series' },
          { type: 'boardgameaccessory', id: '7', value: 'Catan Dice' },
          { type: 'rpgitem', id: '8', value: 'D&D Starter Set' },
          { type: 'videogame', id: '9', value: 'Catan Digital' },
        ],
      };
      ...
      expect(result.links).toEqual(expect.arrayContaining([
        ...
        expect.objectContaining({
          ...
          linkType: 'BOARDGAME_DESIGNER',
          isExpansionLink: false,
        }),
        expect.objectContaining({
          type: 'boardgameartist',
          linkType: 'BOARDGAME_ARTIST',
          isExpansionLink: false,
        }),
        expect.objectContaining({
          type: 'boardgamepublisher',
          linkType: 'BOARDGAME_PUBLISHER',
          isExpansionLink: false,
        }),
        expect.objectContaining({
          type: 'boardgamefamily',
          linkType: 'BOARDGAME_FAMILY',
          isExpansionLink: false,
        }),
        expect.objectContaining({
          type: 'boardgameaccessory',
          linkType: 'BOARDGAME_ACCESSORY',
          isExpansionLink: false,
        }),
        expect.objectContaining({
          type: 'rpgitem',
    ...
    it('should handle unknown link types', async () => {
      const mockItem = {
        ...
        name: { type: 'primary', value: 'CATAN' },
        link: [
          { type: 'unknownlink', id: '1', value: 'Unknown' },
        ],
      };
