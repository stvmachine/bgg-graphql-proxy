...
describe('BGGDataSource - Collection Tests', () => {
  ...
  describe('getUserCollection', () => {
    it('should parse stevmachine collection correctly', async () => {
        ...
        item: [
          {
            ...
            thumbnail: 'https://cf.geekdo-images.com/35h9Za_JvMMMtx_92kT0Jg__small/img/BUOso8b0M1aUOkU80FWlhE8uuxc=/fit-in/200x150/filters:strip_icc()/pic7149798.jpg',
            status: {
              own: '0',
              prevowned: '1',
              fortrade: '0',
      ...
      jest.spyOn(bggDataSource as any, 'makeRequest').mockResolvedValue(mockData);
