...
/**
 * Data Fetcher for Render Deployment
 * This script fetches data from BGG API and populates the Render PostgreSQL database
 */
...
// Database connection - will use Render's database URL
const client = new Client({
  connectionString: process.env.DATABASE_URL || process.env.HASURA_GRAPHQL_DATABASE_URL,
...
async function fetchBGGData() {
  console.log('🚀 Starting BGG data fetch for Render...');
